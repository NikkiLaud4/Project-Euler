...
def horizondal():
    max_prod=1
    print("Horizondal Start")
    for i in range(20):
        for j in range(17):
            prod=arr[i][j]*arr[i][j+1]*arr[i][j+2]*arr[i][j+3]
            if prod>max_prod:
                print(prod,"**",max_prod,"Numbers:",arr[i][j],arr[i][j+1],arr[i][j+2],arr[i][j+3])
                max_prod=prod
    print("Horizondal End")
    return max_prod
...
def vertical():
    ...
    for i in range(20):
        for j in range(17):
            ...
            if prod>max_prod:
                print(prod,"**",max_prod,"Numbers:",arr[j][i],arr[j+1][i],arr[j+2][i],arr[j+3][i])
                max_prod=prod
    print("Vertical End")
    return max_prod
